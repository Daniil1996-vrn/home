...
$oplata="<html lang='en'>
 ...
 <script src='js/jquery.js'></script>
  ...
  <body>
    ...
    <a  class='btn btn-primary' name='button' href=files/$file download>Скачать работу</a>
...
if(isset($header) and isset($body)  and isset($file))
{
...
$text=$header2.$body2.$time2.$oplata."\r\n"."<hr>\r\n";
$text.=file_get_contents("articles.html").PHP_EOL;
file_put_contents("articles.html",$text);

if ($conn->connect_error) die($conn->connect_error);
 $query2 = "INSERT INTO articles(chislo,date,nazvanie,avtor,file) VALUES('"."$chislo'".",'"."$time',"."'$header'".",". "'$user'".","."'$file'".")";
echo $query2;
