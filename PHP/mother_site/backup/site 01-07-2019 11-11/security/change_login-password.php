...
<input type='password' name='password' class='form-control' placeholder='Новый пароль' size='32' maxlength='32'  required  >
    <br><br>
    <input type='password' name='password2' class='form-control' placeholder='Повторите пароль' size='32' maxlength='32'  required  >
