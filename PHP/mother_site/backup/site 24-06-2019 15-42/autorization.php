...
if($login==$row['login'] &&$password2==$row['password'] ) $prov=1;
  ...
  <body>
    ...
    <div class="container" align="center">
      ...
      <form class="form-signin" role="form" action="autorization.php"   method="post">
        ...
        <input id="login" type="text" class="form-control" placeholder="Login" required autofocus name="login"><br>
        <input id="password" type="password" class="form-control" placeholder="Password" required name="password"><br>
